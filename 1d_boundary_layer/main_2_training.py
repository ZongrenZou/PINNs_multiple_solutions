...
torch.save(model, "./checkpoints_2/model_0_case2")
...
def train(): 
    ...
    for i in range(niter):
        ...
        if (i + 1) % 50 == 0:
            ...
            torch.save(model, "./checkpoints_training/model_case2_{}".format(str(i+1)))
            model.train()
...
# torch.save(model, "./checkpoints_2/model_case2")
