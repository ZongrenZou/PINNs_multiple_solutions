...
model = torch.load("./checkpoints_3/model_1")
x_test = torch.tensor(
...
ax.set_title("Constraint: $u(-0.3)>0$")
ax.set_ylim([-2, 2])
ax.set_xlim([-0.5, 0.5])
ax.set_aspect(0.25)
ax.set_xlabel("$x$")
ax.set_ylabel("$u$")
fig.savefig("./results/u_case_3.png", bbox_inches="tight")


model = torch.load("./checkpoints_4/model_1")
...
ax.set_xlabel("$x$")
ax.set_ylabel("$u$")
fig.savefig("./results/u_case_4.png", bbox_inches="tight")