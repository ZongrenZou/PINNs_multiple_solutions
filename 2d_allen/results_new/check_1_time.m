...
ax = gca;
exportgraphics(ax,'case1_0.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case1_1.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case1_2.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case1_3.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case1_4.png','Resolution',300) 
