...
ax = gca;
exportgraphics(ax,'case2_0.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case2_1.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case2_2.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case2_3.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case2_4.png','Resolution',300) 
