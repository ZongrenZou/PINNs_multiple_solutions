...
ax = gca;
exportgraphics(ax,'case4_0.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case4_1.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case4_2.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case4_3.png','Resolution',300) 
...
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
ax = gca;
exportgraphics(ax,'case4_4.png','Resolution',300) 
