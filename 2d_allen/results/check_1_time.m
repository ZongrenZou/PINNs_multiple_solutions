...
xlim([0, 1])
ylim([0, 1])
title("$u_0$", "FontSize", 20, "Interpreter", "latex")
...
xlim([0, 1])
ylim([0, 1])
title("$u_{15}$", "FontSize", 20, "Interpreter", "latex")
xlabel("$x$", "FontSize", 20, "Interpreter", "latex")
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
...
xlim([0, 1])
ylim([0, 1])
title("$u_{50}$", "FontSize", 20, "Interpreter", "latex")
xlabel("$x$", "FontSize", 20, "Interpreter", "latex")
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
...
xlim([0, 1])
ylim([0, 1])
title("$u_{100}$", "FontSize", 20, "Interpreter", "latex")
xlabel("$x$", "FontSize", 20, "Interpreter", "latex")
ylabel("$y$", "FontSize", 20, "Interpreter", "latex")
