...
fig.savefig("./results/u_case_b_pinn.png", bbox_inches="tight")



data_densest = sio.loadmat("./results/case_b_densest.mat")
...
fig = plt.figure(dpi=200)
ax = fig.add_subplot()
ax.plot(x, np.sin(10*x)**3, "k--", linewidth=3)
for i in range(9):
...
fig.savefig("./results/u_case_b_our.png", bbox_inches="tight")