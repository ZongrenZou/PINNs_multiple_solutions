...
model = torch.load("./checkpoints_a/model_1_case1")
...
fig.savefig("./results/u_case_a_case1.png", bbox_inches="tight")


model = torch.load("./checkpoints_a/model_1_case2")
u_pred = model.forward(xx).detach().cpu().numpy()
fig = plt.figure(dpi=200)
ax = fig.add_subplot()
ax.plot(x_test, u_test, "k--", linewidth=3)
...
ax.set_ylabel("$u$")
# ax.legend(["The prescribed solution", "PINN solutions"], frameon=False)
fig.savefig("./results/u_case_a_case2.png", bbox_inches="tight")
...
ax.set_ylabel("$u$")
# ax.legend(["The prescribed solution", "PINN solutions"], frameon=False)
fig.savefig("./results/u_case_a_case3.png", bbox_inches="tight")
